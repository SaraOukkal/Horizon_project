...
input_dir="/beegfs/project/horizon/data/mapping/BUSCO_depth/"
...
while IFS= read -r ligne; do
    ...
    ancien_nom_complet="${input_dir}BUSCO_${ancien_nom}.per-base.bed"
    nouveau_nom_complet="${input_dir}BUSCO_${nouveau_nom}.per-base.bed"
